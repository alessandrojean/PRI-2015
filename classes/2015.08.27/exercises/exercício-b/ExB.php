...
<link href="ExB_estilo.css" rel="stylesheet" type="text/css" />
</head>
...
for($x=1;$x<15;$x++)
{
	...
	if($x%2==0)
	{
		$saida.="<td id='par'>Esta é a linha PAR da tabela</td>";	
	}
	else
	{
		$saida.="<td id='impar'>Esta é a linha ÍMPAR da tabela</td>";	
	}
	$saida.="</tr>";
}
$saida.="</table>";
