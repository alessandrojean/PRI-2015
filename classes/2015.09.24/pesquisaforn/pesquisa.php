...
<option value="CodFor" selected="selected">Código</option>
<option value="NomeFor">Nome</option>
<option value="EndFor">Endereço</option>
<option value="CidadeFor">Cidade</option>
<option value="EstadoFor">Estado</option>
<option value="FoneFor">Telefone</option>
</select>
</label>
